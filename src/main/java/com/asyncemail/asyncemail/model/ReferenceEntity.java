...
public class ReferenceEntity implements Serializable{
    ...
    /*
     * The default serial version UID. The serialization id is used to when serializing and deserializing an object.
     */
    ...
    /*
     * The ordinal value facilities sorting the entities.
     */
    @NotNull
    ...
    /**
     *  The timestamp at which the entity's value cease to be used by the
